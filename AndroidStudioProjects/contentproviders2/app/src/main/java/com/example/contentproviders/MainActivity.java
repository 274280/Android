...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      recycle = findViewById(R.id.recycler);
        ...
        Log.i("MainActivity", "after initializing adapter");
        ...
        public void onClickShowDetails (View view){
            ...
            // content URI
            Log.i("MainActivity", "onclickshowdetails");
...
//                        .append("-").append(cursor.getString(cursor.getColumnIndex(MyContentProvider.EmployeeID))).append("-").append(cursor.getString(cursor.getColumnIndex(MyContentProvider.Salary)));
                    list.add(new employeedata(cursor.getString(cursor.getColumnIndex(MyContentProvider.name)), cursor.getString(cursor.getColumnIndex(MyContentProvider.EmployeeID)), cursor.getString(cursor.getColumnIndex(MyContentProvider.Salary))));
